...
public class TeacherAddQuizTitleDescFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View aview = inflater.inflate(R.layout.fragment_teacher_add_quiz_title_desc, container, false);
        aview.findViewById(R.id.buttonCreateQuiz).setOnClickListener(new View.OnClickListener(){
            @Override
